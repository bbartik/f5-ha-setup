...
bigip1_address = '192.168.9.100'
bigip1_name = 'bigip1a.bb.lab'
bigip2_address = '192.168.9.101'
bigip2_name = 'bigip1b.bb.lab'
bigip_user = 'admin'
bigip_pass = 'admin'
ha_vlan_name = 'HA'
ha_interface = '1.3'
ha_self_name = 'HA-Self'
...
bigip2 = {
    ...
    "user" : bigip_user,
    "pass" : bigip_pass,
    "ha_self_ip" : "192.168.255.2/24",
    "ha_vlan_name" : ha_vlan_name,
    "ha_interface" : ha_interface,
    "ha_self_name" : ha_self_name,
    "configsyncIp" : "192.168.255.2",
...
float = []
float.append({"name":"Internal-Float","address":"192.168.9.99/24","vlan":"internal"})
float.append({"name":"DMZ-Float","address":"192.168.30.99/24","vlan":"dmz"})
